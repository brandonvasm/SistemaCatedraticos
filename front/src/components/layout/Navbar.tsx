  ...
  return (
    <>
      <nav className="fixed top-0 right-0 left-64 h-20 flex items-center justify-between px-10 bg-transparent border-b border-white/5 z-[40]">
        ...
        <div
          ref={searchRef}
          className="flex-1 flex justify-center max-w-xl relative"
        >
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <div className="flex flex-col items-start leading-none gap-1">
              <span className="text-[7px] text-gray-500 group-hover:text-red-400 transition-colors">
                SEMESTRE ACTUAL
              </span>
          ...
          <div
            ...
            className="relative cursor-pointer group p-1.5 ml-2"
          >
            <Bell
              size={20}
