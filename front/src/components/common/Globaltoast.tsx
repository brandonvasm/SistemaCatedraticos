      ...
      {status === 'processing' ? (
        <div className="bg-[#0f111a] border border-yellow-400/20 backdrop-blur-2xl px-8 py-5 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.7)] flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <span className="text-white text-[11px] font-black uppercase tracking-[0.2em]">Procesamiento activo</span>
            <span className="text-gray-500 text-[9px] font-bold uppercase tracking-widest mt-0.5">La carga de archivos estará en segundo plano unos minutos</span>
          </div>
        </div>
      ) : (
        <div className="bg-[#0f111a] border border-green-500/30 backdrop-blur-2xl px-8 py-5 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.7)] flex items-center gap-5 animate-in zoom-in duration-300">
          ...
          <div className="flex flex-col text-left">
            <span className="text-white text-[11px] font-black uppercase tracking-[0.2em]">¡Carga Completada!</span>
            <span className="text-gray-500 text-[9px] font-bold uppercase tracking-widest mt-0.5">Los datos se han actualizado correctamente</span>
          </div>
