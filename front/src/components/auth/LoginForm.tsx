    ...
    <div className="w-full max-w-[500px] min-h-[600px] p-10 bg-[#0b101f]/60 border border-white/10 backdrop-blur-[30px] rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-10 flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="text-center mb-4 flex flex-col items-center relative z-10">
        <div className="w-full h-24 flex items-center justify-center mb-8 relative">
          <img
            src="/letraslandivar.png" 
            alt="Logo Landívar"
            className="h-full w-auto object-contain transform scale-[2.5] transition-transform duration-300"
          />
        </div>
        ...
        <p className="text-gray-500 font-bold text-[10px] uppercase tracking-[0.3em] mt-4">
          EVALDOCENTE · FACULTAD DE INGENIERÍA
        </p>
      </div>
      ...
      <form className="space-y-7 relative z-10" onSubmit={handleSubmit} noValidate>
        <div className="space-y-3">
          <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-2">
          ...
          <div className="relative group">
            ...
            <input 
              ...
              className={`w-full bg-white/[0.02] border rounded-2xl py-5 pl-16 pr-6 text-xs font-bold text-white outline-none transition-all tracking-widest shadow-inner ${error ? 'border-red-500/40 bg-red-500/5' : 'border-white/5 focus:border-yellow-400/40 focus:bg-white/[0.05]'}`}
              value={email}
        ...
        <div className="space-y-3">
          ...
          <div className="relative group">
            ...
            <input 
              ...
              placeholder="••••••••"
              className={`w-full bg-white/[0.02] border rounded-2xl py-5 pl-16 pr-16 text-xs font-bold text-white outline-none transition-all tracking-widest shadow-inner ${error ? 'border-red-500/40 bg-red-500/5' : 'border-white/5 focus:border-yellow-400/40 focus:bg-white/[0.05]'}`}
              value={password}
        ...
        <button 
          type="submit"
          disabled={isLoading}
          className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-black py-5 rounded-[2rem] shadow-[0_10px_30px_rgba(250,204,21,0.2)] flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-50 uppercase tracking-[0.2em] text-[11px] mt-4"
        >
          {isLoading ? (
      ...
      <p className="text-center text-[9px] text-gray-600 font-bold uppercase tracking-widest mt-10 relative z-10">
